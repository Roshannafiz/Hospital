<div class="page-section">
    <div class="container">
        <h1 class="text-center wow fadeInUp" style="font-size: 2.5em !important">Make an Appointment</h1>
        ...
        <form class="main-form" action="{{ url('appointment') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mt-5 ">
                ...
                <div class="col-12 py-2 wow fadeInUp" data-wow-delay="300ms">
                    <input type="text" required name="number" class="form-control" placeholder="Number..">
                </div>
                <div class="col-12 py-2 wow fadeInUp" data-wow-delay="300ms">
                    <textarea name="message" required id="message" class="form-control" rows="6"
